		...
		<form name="form1" method="post" action="${app}/servlet/OrderAdd">
			...
			<table width="1200" height="80" border="1" cellpadding="0" cellspacing="0" bordercolor="#d8d8d8">
			  ...
			  <c:forEach items="${sessionScope.cart}" var="entry">
				<tr>
					<td><img width="100px" height="100px" src="${app}/servlet/ProdImg?id=${entry.key.id}"/></td>
